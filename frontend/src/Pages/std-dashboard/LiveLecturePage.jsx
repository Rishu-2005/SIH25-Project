    ...
    <div className="livelecture">
      ...
      <aside className="sidebar">
        ...
        <nav>
          <ul>
            <li className="active">
              <img src={liveIcon} alt="Live" /> Live Lecture
            </li>
            <li>
              <img src={dashIcon} alt="Dashboard" /> Dashboard
            </li>
            <li>
              <img src={timetableIcon} alt="Timetable" /> Timetable
            </li>
            <li>
            ...
            <li>
              <img src={materialsIcon} alt="Materials" /> Materials
            </li>
          </ul>
        </nav>
      ...
      <main className="lecture-main">
        ...
        <div className="lecture-video waiting">
          <div className="waiting-text">⏳ Wait for the class to start…</div>
        </div>
        ...
        <div className="lecture-controls">
          ...
          <button className="raise-hand">
            <img src={raiseHandIcon} alt="" /> Raise Hand
          </button>
          <button>
            <img src={openChatIcon} alt="" /> Open Chat
          </button>
          <button>
      ...
      <aside className="chat-section">
        ...
        <div className="chat-messages">
          <div className="message">
            <strong>Yashasv Gupta:</strong> Could you explain the difference
            between supervised and unsupervised learning again?
          </div>
          <div className="message">
            <strong>Shivam Singh:</strong> The example with neural networks
            really helped, thanks!
          </div>
          <div className="message">
            <strong>Pranay Kumar:</strong> Is the homework due before next class
            or end of week?
          </div>
          <div className="message">
            <strong>Ayush Singh:</strong> This is very helpful 🙌
          </div>
        </div>
        ...
        <div className="resources">
          <div className="resource">
            <div>
              Lecture Slides – Week 4<span className="size">PDF · 100KB</span>
            </div>
